...

{
  home.file = {
    ...
    ".config/quickshell/qmldir".source = ./quickshell/qmldir;
    ...
    ".config/quickshell/Workspaces.qml".source = ./quickshell/Workspaces.qml;
    ".config/quickshell/Battery.qml".source = ./quickshell/Battery.qml;
  };
}
